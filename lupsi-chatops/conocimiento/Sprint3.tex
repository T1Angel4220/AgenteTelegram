...
\section{Presupuesto y Retorno de Inversión (ROI)}
El desarrollo y despliegue del Ecosistema Móvil PWA aporta un valor económico sustancial. Aunque el proyecto tiene una valoración de mercado estimada en \$4,724.50 (correspondiente al esfuerzo en análisis, diseño, desarrollo y pruebas), al ser ejecutado en un entorno académico, esta inversión es absorbida por el equipo de desarrollo.

Esto reduce el desembolso real del centro médico a únicamente \$200 iniciales, lo que elimina el riesgo financiero institucional. Se estima, de manera referencial, que esta inversión se recuperará en un periodo aproximado de 10 a 12 meses gracias a la optimización operativa, reducción de ausentismo de pacientes y ahorro en gestión administrativa, consolidando el beneficio directo de las implementaciones del sprint.
